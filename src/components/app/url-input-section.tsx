      ...
      <div className="w-full max-w-2xl mt-4">
        <div className="relative">
          ...
          <Textarea
            ...
            className="pl-12 pr-4 py-4 min-h-[56px] text-base rounded-3xl border-gray-300 focus-visible:ring-primary focus-visible:ring-2 shadow-sm hover:shadow-md transition-shadow resize-none flex items-center"
